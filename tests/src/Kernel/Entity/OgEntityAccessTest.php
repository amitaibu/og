...
/**
 * @file
 * Contains Drupal\Tests\og\Kernel\Entity\OgEntityAccessTest.
 */
...
class OgEntityAccessTest extends KernelTestBase {
  ...
  protected function setUp() {
    ...
    $membership
      ...
      ->setEntityType($this->nodeGroup->getEntityTypeId())
      ->save();
  ...
  /**
   * Testing group's permission inside non-node groups.
   */
  public function testEntityTestGroupPermission() {
